        ...
        {packageRequiresInsurance(booking.packageType) && booking.insurance && (
          <section className={styles.section}>
            ...
            <div className={styles.fieldGrid}>
              ...
              <div className={styles.field}>
                <span className={styles.fieldLabel}>{t.bookings.detail.timeOfLoss}</span>
                <span className={styles.fieldValue}>{booking.insurance.timeOfLoss ? formatTime(booking.insurance.timeOfLoss) : '—'}</span>
              </div>
            </div>
          </section>
        )}
        ...
        <section className={styles.section}>
          ...
          <div className={styles.fieldGrid}>
            ...
            <div className={styles.field}>
              ...
              <span className={styles.fieldValue}>{booking.bookingTime ? formatTime(booking.bookingTime) : '—'}</span>
            </div>
            <div className={styles.field}>
